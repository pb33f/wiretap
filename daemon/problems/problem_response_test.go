...
func TestWriteValidationProblemResponseStatusAndContentType(t *testing.T) {
...
func TestWriteValidationProblemResponseStripsUpstreamEncodingHeaders(t *testing.T) {
	rec := httptest.NewRecorder()
...
func TestWriteValidationProblemResponseBodyShape(t *testing.T) {
	rec := httptest.NewRecorder()
...
func TestWriteValidationProblemResponseBothSides(t *testing.T) {
	rec := httptest.NewRecorder()
